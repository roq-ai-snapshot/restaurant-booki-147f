  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Restaurant Booking Engine, your comprehensive solution for managing table reservations and menus. Turning customer convenience into your business advantage."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Restaurant Booking Engine, your comprehensive solution for managing table reservations and menus. Turning customer convenience into your business advantage.`}
            </Text>
            <Box
